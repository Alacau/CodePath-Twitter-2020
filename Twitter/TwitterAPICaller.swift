...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    ...
    func favoriteTweet(_ tweetID: Int, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
    ...
    func unfavoriteTweet(_ tweetID: Int, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
    ...
    func retweetTweet(_ tweetID: Int, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
